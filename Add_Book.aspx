                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td class="auto-style13" style="text-align:right">
                            ...
                            Text="UPDATE" OnClick="GridView1_RowUpdating"/></td>
                        </td>
                        <td class="auto-style14">
                            <asp:Button ID="Button3" runat="server" CssClass="btn" Font-Size="Small"
                            Text="CANCEL" OnClick="GridView1_RowCancelingEdit"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style18">
        ...
        <tr>
            <td>
                <table align="center" class="auto-style23">
                    <tr align="center">
                        <td>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="963px" AllowPaging="true" 
                                OnRowEditing="GridView1_RowEditing" OnRowDeleting="GridView1_RowDeleting" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true"> 
